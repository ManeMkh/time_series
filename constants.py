...
T = {
    'en': {
        ...
        'about_p2':      (
            ...
            'data from 2008–2025, covering five elections, and apply VAR, XGBoost, '
    ...
    'hy': {
        ...
        'about_p1':      (
            ...
            'ընտրություններից առաջ տնտեսությունը մանիպուլացնւմ են՝ հաղթելու համար։ '
            'Ավելացնում են ծախսերը, ընդլայնում գումարի մատակարարումը կամ '
        ...
        'about_p2':      (
            ...
            'Օգտագործել ենք 2008–2025թթ. եռամսյակային տվյալներ, ընդգրկելով 5 ընտրություն, '
            'և կիրառում ենք VAR, XGBoost, LSTM մոդելներ։'
        ),
        'stat_q':        'Եռամսյակ',             'stat_q_s': '2008 Ե1 – 2025 Ե4',
        'stat_e':        'Ուսումնասիրված ընտրություններ', 'stat_e_s': '2008, 2012, 2017, 2018, 2021',
        ...
        'col_freq':      'Հաճախականություն', 'col_src': 'Աղբյուր',
        'annual_note':   '* Տարեկան պետական ծախսերը ինտերպոլացվեցին եռամսյակային հաճախությամբ։',
        'clean_h':       'Ինչպե՞ս մաքրվեցին տվյալները',
        'clean_sub':     'Կառավարության կողմից նախապես տրված տվյալները անկանոն են, ահա թե ինչ ենք արել',
        'c1h': 'Excel-ի կառուցվածքի ուղղում',
        'c1p': 'Armstat-ի ֆայլերում տարեթվերը տրված էին տվյալների տողում, ոչ թե սյւնակի գլխամասւմ։ Ավտոմատ դւրս բերեցինք։',
